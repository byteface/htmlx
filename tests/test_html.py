...
class TestCase(unittest.TestCase):
    ...
    def test_htmlx_get(self):
        print("test_htmlx_get-----------=-----------=-----------=-----------=-----------=-----------=-----------=")
        page = htmlx.get("http://eventual.technology")
        page = htmlx.get("https://v5.getbootstrap.com/docs/5.0/examples/checkout/")
        page = htmlx.get("https://v5.getbootstrap.com/docs/5.0/examples/carousel/?#")
        page = htmlx.get("https://v5.getbootstrap.com/docs/5.0/examples/dashboard/#")
        page = htmlx.get("https://www.google.com")
        page = htmlx.get("https://www.facebook.com")
        print("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<")
        print(render(page))
        pass

    @silence
    def test_htmlx_render(self):
        test = html(
            head(
            meta(_charset="utf-8"),
    ...
    @silence
    def test_htmlx_render_head(self):
        test = head(
            meta(_charset="utf-8"),
            # meta(**{"http-equiv": "X-UA-Compatible"},, _content="IE=edge"),
            title("byteface"),
    ...
    @silence
    def test_htmlx_render_bs5_checkout(self):
        test = html(
            head().html(
                meta(_charset="utf-8"),
                meta(_name="viewport", _content="width=device-width, initial-scale=1"),
    ...
    @silence
    def test_htmlx_render_bs5_carousel(self):
    ...
    @silence
    def test_htmlx_render_bs5_dashboard(self):
        root = html(_lang="en")
        test = root.html(
            head(
                meta(_charset="utf-8"),
    ...
    def test_htmlx_render_a_tag(self):
    ...
    def test_htmlx_render_a_tag_query_params(self):
        # from htmlx import a, render
        urls = [
    ...
    def test_four_oh_four(self):
        # https://github.com/byteface/htmlx/issues/37
        four_oh_four = html(
            head(
                meta(_charset="utf-8")
            ),
    ...
    def test_boolean_attributes(self):
        # https://github.com/byteface/htmlx/issues/40
