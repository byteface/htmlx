...
class TestCase(unittest.TestCase):
    ...
    def test_sitemapindex(self):
        ...
        from htmlx.xml.sitemap import sitemap, sitemapindex, url, urlset
    ...
    def test_loadsitemap(self):
        from htmlx.xml.sitemap import get_sitemap
    ...
    def test_element_class(self):
        ...
        # sitemapindex = Document.createElement('sitemapindex') # TODO - should createElementClass be a method of htmlx Document?
        pass
