...
class TestCase(unittest.TestCase):
    ...
    def test_Node(self):
        ...
        # which stops that parser working with htmlx
        #
    ...
    def test_decorators(self):
        from htmlx.decorators import el
    ...
    def test_htmlx_window_console_log(self):
    ...
    def test_treewalker(self):
        ...
        from htmlx.dom import Comment, TreeWalker
...
class NodeTest(TestCase):
    # found these unit tests for a 17 yr old dom implementation. modded them to work on htmlx.
