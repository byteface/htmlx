...
class Document(Element):
    ...
    def createElement(_type: str, *args, **kwargs):
        ...
        from htmlx.html import create_element
...
def render(inp, outp="", to=None):  # doctype='html5')
    ...
    Args:
        inp (obj): A htmlx tag. For example div()
...
meta = type(
    "meta", (closed_tag, Element), {"name": "meta"}
...
img = type(
    "img", (closed_tag, Element), {"name": "img"}
)  # HTMLImageElement TODO - closed tags
