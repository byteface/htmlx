# # steal and mod the expatbuilder built into python used by mindom and try get it to return htmlx instead

# """Facility to use the Expat parser to load a htmlx instance from a string or file.
...
# # htmlx DOM and can't be used with other DOM implementations.  This
...
# from htmlx.decorators import check
...
#             print(
#                 'TODO - still need to ammend htmlx to "have" a root not "be" the root. As not allows multiple nodes at root'
#             )
...
#         from htmlx.parsers import create_element
...
#             # NOTE - because the htmlx Document is a tag. the first one needs to be the root
...
#         # TODO rewrite this to use htmlx instead of minidom
#         """
#         if attributes:
